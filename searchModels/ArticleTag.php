...
use common\modules\article\models\ArticleTag as ArticleTagModel;

/**
 * ArticleTag represents the model behind the search form about `common\modules\article\models\ArticleTag`.
 */
class ArticleTag extends ArticleTagModel
{
    ...
    {
        return [
            [['id', 'active', 'visible', 'featured', 'shown_on_menu', 'doindex', 'dofollow', 'type', 'status', 'sort_order', 'create_time', 'update_time', 'creator_id', 'updater_id', 'image_id'], 'integer'],
