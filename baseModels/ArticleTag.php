 ...
 */
class ArticleTag extends \common\db\MyActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['active', 'visible', 'featured', 'shown_on_menu', 'doindex', 'dofollow', 'type', 'status', 'sort_order', 'create_time', 'update_time', 'creator_id', 'updater_id', 'image_id'], 'integer'],
    ...
    {
        return $this->hasMany(ArticleToTag::className(), ['article_tag_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(Article::className(), ['id' => 'article_id'])->viaTable('article_to_tag', ['article_tag_id' => 'id']);
    }
}
